      ...
      <div className="rounded-lg bg-gray-100 p-6 shadow-md">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <div className="rounded-md bg-white p-4 shadow">
            <h3 className="mb-2 text-lg font-semibold">NAV</h3>
          ...
          <div className="rounded-md bg-white p-4 shadow">
            <h3 className="mb-2 text-lg font-semibold">AUM</h3>
        ...
        <div className="mt-6 grid grid-cols-2 gap-4">
          <div>
            <h3 className="mb-2 font-semibold">Symbol</h3>
            <p>GBS</p>
          </div>
          <div>
            <h3 className="mb-2 font-semibold">Share Class Asset</h3>
            <p>USDC</p>
          </div>
          <div>
            <h3 className="mb-2 font-semibold">Management Fee</h3>
            <p>1.5%</p>
          </div>
          <div>
            <h3 className="mb-2 font-semibold">Performance Fee</h3>
            <p>10%</p>
          </div>
        </div>
      </div>
